...
import com.sambilan.sambilan.view.adapter.PermintaanAdapter;
...
public class PermintaanActivity extends AppCompatActivity implements PermintaanAdapter.PermintaanListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        permintaanAdapter = new PermintaanAdapter(PermintaanActivity.this, jobs, this);
        recyclerPermintaan = findViewById(R.id.rv_page_permintaan);
        recyclerPermintaan.setLayoutManager(new LinearLayoutManager(PermintaanActivity.this));
    ...
    private JobPresenter.JobResultCallback jobCallback = new JobPresenter.JobResultCallback() {
        ...
        public void OnSuccessResult(List<Job> jobs) {
            PermintaanActivity.this.jobs.addAll(jobs);
            PermintaanActivity.this.permintaanAdapter.notifyDataSetChanged();
        }

        @Override
        public void OnFailureResult(String errorMessage) {
            Toast.makeText(PermintaanActivity.this, ""+errorMessage, Toast.LENGTH_LONG)
                    .show();
        }
    };
    ...
    public void onClickTolak() {
        Toast.makeText(this, "TELIK", Toast.LENGTH_SHORT).show();
    }
}
